  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+263) 77 444 0784</p>
                <?php if (isset($_SESSION['applicant_id'])) { 

                    $sql = "SELECT count(*) as 'COUNTNOTIF' FROM `job` ORDER BY `date_posted` DESC";
                    $mydb->setQuery($sql);
                    ...
                    $sql ="SELECT count(*) as 'COUNT' FROM `jobregistration` WHERE `pending_application`=0 AND `hview`=0 AND `applicant_id`='{$appl->applicant_id}'";
                    $mydb->setQuery($sql);
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">LYNK<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Lynk Headquarters<br>
           Harare, Zimbabwe</address>
          <p>
            <i class="icon-phone"></i> (+263) 77 444 0784 <br>
            <i class="icon-envelope-alt"></i> myboemoyo@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            <?php 
                  $sql = "SELECT * FROM `company` c,`job` j WHERE c.`company_id`=j.`company_id`   ORDER BY date_posted DESC LIMIT 3" ;
                  $mydb->setQuery($sql);
                  $cur = $mydb->loadResultList();


                  foreach ($cur as $result) {
                    echo ' <li><a href="'.web_root.'index.php?q=viewjob&search='.$result->company_id.'">'.$result->company_name . '/ '. $result->occupation_title .'</a></li>';
                  } 
              ?> 
          </ul>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; M Moyo 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
 ...
 <script type="text/javascript">
    ...
    $('#dash-table2').DataTable({
     ...
     $("#btnLogin").click(function(){
        ...
        $("#btnEmployerLogin").click(function(){
        var username = document.getElementById("employer_email");
        var pass = document.getElementById("employer_pass");
        ...
        $("#applicantlogin").click(function(){
        var username = document.getElementById("applicant_email");
        var pass = document.getElementById("applicant_pass");
