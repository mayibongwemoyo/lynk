                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                        <span class="input-group-addon"> 
                         ...
                         <input class="form-control input-sm date_picker" id="birth_date" name="birth_date" placeholder="Date of Birth" type="text"    value="<?php echo date_format(date_create($appl->birth_date),'m/d/Y');?>" required  autocomplete="off">
                    </div>
                  </div>
                </div>
              </div>  
                  ...
                  <div class="col-md-11">
                    ...
                    <div class="col-md-8">
                       ...
                       <textarea class="form-control input-sm" id="birth_place" name="birth_place" placeholder=
                          "Place of Birth" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"><?php echo $appl->birth_place;?></textarea>
                    </div>
                  </div>
                </div> 
