							...
							<table id="dash-table" class="table table-striped  table-hover table-responsive" style="font-size:12px" cellspacing="0">
							  ...
							  <tbody>
							  	<?php   
							  		...
							  		$mydb->setQuery("SELECT * FROM `company` c  , `jobregistration` j, `job` j2, `tblapplicants` a WHERE c.`company_id`=j.`company_id` AND  j.`company_id`=j2.`company_id` AND j.`applicant_id`=a.`applicant_id` ");
