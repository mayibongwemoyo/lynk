...
// $res = $autonum->single_autonumber(2);
 @$empid = $_GET['id'];
  ...
  $birthday = date_format(date_create($emp->birth_date),'m/d/Y');
  $mv = date_format(date_create($emp->birth_date),'m');
  $m =date_format(date_create($emp->birth_date),'M');
  $d = date_format(date_create($emp->birth_date),'d');
  $y = date_format(date_create($emp->birth_date),'Y');
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                  <div class="input-group " > 
                                      <!-- <label><?php echo date_format(date_create($emp->birth_date),'m/d/Y'); ?> </label>  
