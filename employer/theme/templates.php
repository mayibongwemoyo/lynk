...
<html>
    <head>
        ...
        <title><?php
                ...
                // $res = mysql_query($query) or die($cur = $mydb->sqli_error());
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo web_root;?>/employer/" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>LYNK</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>LYNK</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <?php
              ...
              $singlemployer = $employer->single_employer($_SESSION['employer_id']);

          ?>
          <!-- User Account: style can be found in dropdown.less -->
          <li class="dropdown user user-menu" style="padding-right: 15px;"  >
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo web_root.'employer/user/'. $singlemployer->PICLOCATION;?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $singlemployer->fname; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header"> 
                <img data-target="#menuModal"  data-toggle="modal"  src="<?php echo web_root.'employer/user/'. $singlemployer->PICLOCATION;?>" class="img-circle" alt="User Image" />  
              </li> 
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo web_root.'employer/user/index.php?view=view&id='.$_SESSION['employer_id'] ;?>" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo web_root ;?>employer/logout.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
        <li  class="<?php echo (currentpage() == 'index.php') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>employer/">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>  
          </a> 
        </li> 

        <li class="<?php echo (currentpage() == 'company') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>employer/company/">
        ...
        <li class="<?php echo (currentpage() == 'applicants') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>employer/applicants/">
            ...
            <span class="label label-primary pull-right">
              <?php
                // $sql = "SELECT count(*) as 'APPL' FROM `jobregistration` WHERE `pending_application`=1";
                // $mydb->setQuery($sql);
        ...
        <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>employer/category/">
       ...
       <!--  <li class="treeview">
         ...
         <li class="<?php echo (currentpage() == 'user') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>employer/user/">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="#">M Moyo</a>.</strong> All rights
    reserved.
  </footer>
